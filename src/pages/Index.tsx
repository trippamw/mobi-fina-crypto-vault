...
const Index = () => {
            ...
            <Card className="gradient-card border-border/50 bg-gradient-to-r from-accent/10 to-primary/10">
              <CardContent className="pt-4 sm:pt-6">
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" className="gradient-primary" onClick={() => handleQuickAction('invite')}>
                    Invite
                  </Button>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="space-y-3 sm:space-y-4">
                  {[
                    ...
                    { type: 'Exchange', amount: '0.001 BTC → MWK 168,000', from: 'Crypto Exchange', time: '1 hour ago', status: 'completed' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-background/90 pb-20 md:pb-0">
      ...
      {/* Mobile Navigation */}
      <MobileNavigation activeTab={activeTab} onTabChange={handleMobileNavigation} />
    </div>
  );
};
